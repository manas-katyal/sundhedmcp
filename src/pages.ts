...
<meta name="color-scheme" content="light dark"><title>${esc(title)} · SundhedMCP</title><link rel="icon" href="/favicon.svg?v=5" type="image/svg+xml"><link rel="icon" href="/favicon.ico?v=5" sizes="any"><link rel="apple-touch-icon" href="/apple-touch-icon.png?v=5">${opts.head ?? ""}
<style>
...
<body><div class="wrap">
  <div class="brand"><svg class="mark" viewBox="0 0 512 512" aria-hidden="true"> <defs> <linearGradient id="m-chip" x1="0" y1="0" x2="1" y2="1"> <stop offset="0" stop-color="#ffffff"/> <stop offset="1" stop-color="#f1f1f4"/> </linearGradient> <linearGradient id="m-gloss" x1="0" y1="0" x2="0" y2="1"> <stop offset="0" stop-color="#fff" stop-opacity="0.9"/> <stop offset="0.5" stop-color="#fff" stop-opacity="0"/> </linearGradient> <linearGradient id="m-heart" x1="0.2" y1="0" x2="0.8" y2="1"> <stop offset="0" stop-color="#ffa3be"/> <stop offset="0.38" stop-color="#ff6f96"/> <stop offset="0.72" stop-color="#ff4d7a"/> <stop offset="1" stop-color="#ff2d55"/> </linearGradient> <linearGradient id="m-shine" x1="0" y1="0" x2="0" y2="1"> <stop offset="0" stop-color="#fff" stop-opacity="0.55"/> <stop offset="0.55" stop-color="#fff" stop-opacity="0"/> </linearGradient> <filter id="m-soft" x="-30%" y="-30%" width="160%" height="160%"> <feDropShadow dx="0" dy="8" stdDeviation="12" flood-color="#ff2d55" flood-opacity="0.28"/> </filter> </defs> <rect width="512" height="512" rx="114" fill="url(#m-chip)"/> <rect width="512" height="512" rx="114" fill="url(#m-gloss)"/> <rect x="3" y="3" width="506" height="506" rx="111" fill="none" stroke="#000" stroke-opacity="0.09" stroke-width="6"/> <g transform="translate(256 262) scale(0.9) translate(-256 -262)"> <path d="M256 372C168 314 132 268 132 222c0-40 30-70 68-70 24 0 44 12 56 32 12-20 32-32 56-32 38 0 68 30 68 70 0 46-36 92-124 150z" fill="url(#m-heart)" filter="url(#m-soft)"/> <path d="M256 372C168 314 132 268 132 222c0-40 30-70 68-70 24 0 44 12 56 32 12-20 32-32 56-32 38 0 68 30 68 70 0 46-36 92-124 150z" fill="url(#m-shine)"/> </g> </svg><span>SundhedMCP</span></div>
